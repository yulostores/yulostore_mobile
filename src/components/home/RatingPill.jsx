...
// A rating is a rating: none of these tones tracks veg mode. The chip used to
// turn green across the whole feed the moment veg mode was on, which said
// "vegetarian" about a number that means nothing of the kind.
const TONES = {
  ...
  soft: { pill: "bg-veg-tint", label: "text-veg-ink", ink: colors.veg.ink },
