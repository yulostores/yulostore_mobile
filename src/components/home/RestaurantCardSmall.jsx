...
function OfferRibbon({ label }) {
  return (
    ...
    >
      ...
      >
        <Path d="M91 0.0517578L84.5 5.5L91 10.9473V11H0V0H91V0.0517578Z" fill={colors.primary.ribbon} />
      </Svg>
    ...
    >
      ...
      <View className="gap-3.5 px-[4.5px] pt-[11.5px]">
        ...
        <View className="flex-row items-center gap-[5px] pl-0.5">
          <Clock size={8} color={colors.muted.foreground} />
      ...
      <RatingPill
        ...
        tone={ratingTone}
        className="absolute"
        style={{ left: PILL_LEFT, top: PILL_TOP }}
      />
    </PressableDim>
  );
}
